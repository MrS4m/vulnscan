...
exports.createNetworkRoutes = createNetworkRoutes;
const express_1 = require("express");
const validateRequest_1 = require("../middleware/validateRequest");
const NetworkScanRequestDto_1 = require("../../application/dtos/NetworkScanRequestDto");
function createNetworkRoutes(controller) {
     ...
     */
    router.post('/', (0, validateRequest_1.validateRequest)(NetworkScanRequestDto_1.NetworkScanRequestSchema), (req, res, next) => controller.scan(req, res, next));
    return router;
}
